...
const Events: React.FC = () => {
  ...
  const apiKey = "AIzaSyBRWo6DTySVqQANVSuyw5b9O2aP5VAajg8"; // Replace with your API key
  const clientId =
    "416426082232-31vh92aiq8959gdu909vmceg2je4u1i7.apps.googleusercontent.com";
