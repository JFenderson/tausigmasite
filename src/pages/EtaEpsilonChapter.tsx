...
const RANGE = import.meta.env.VITE_ETA_EPSILON_CHAPTER_RANGE; // Replace with the range in your Google Sheet
...
const EtaEpsilonChapter: React.FC = () => {
  ...
  return (
    <Layout>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Eta Epsilon Chapter</h1>
...
export default EtaEpsilonChapter;
